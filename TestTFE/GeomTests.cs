...
namespace TestTFE.UnitTests
{
    ...
    public class GeomTest
    {
        ...
        public void TestTimeAsCrowFlies()
        {
            ...
            Assert.AreEqual(1.71 / heuristicValue, Math.Round(EuclideanDistanceCostFromTo(node1, node2, heuristicValue)), 2);

            node1 = new Vertex(1, 4.32094751414833, 50.875495617760116);
            node2 = new Vertex(2, 4.467112406894378, 50.83142023866952);

            Assert.AreEqual(11.33 / heuristicValue, Math.Round(EuclideanDistanceCostFromTo(node1, node2, heuristicValue)), 2);
        }
    }
}
